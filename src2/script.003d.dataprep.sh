...
#SBATCH --job-name=003d
#SBATCH --partition=mimir
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16         
#SBATCH --hint=multithread        
#SBATCH --output=messages/messages.003d.out.txt   
#SBATCH --error=messages/messages.003d.err.txt
...
mkdir outdir
date
m6anet dataprep --eventalign eventalign.si_fto_1.txt --out_dir outdir --n_processes 16
date
